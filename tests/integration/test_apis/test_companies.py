...
class TestCompanyAPI:
    def test_company_create(self, api_client, obtain_jwt_token):
    ...
    def test_company_update(self, api_client, obtain_jwt_token):
    ...
    def test_company_list(self, api_client, obtain_jwt_token):
    ...
    def test_company_detail(self, api_client, obtain_jwt_token):
    ...
    def test_company_create_duplicate_name(self, api_client, obtain_jwt_token):
    ...
    def test_company_list_filter(self, api_client, obtain_jwt_token):
